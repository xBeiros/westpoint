            ...
            <div class="relative flex h-16 justify-between">
                ...
                <div class="relative z-10 flex items-center gap-4">
                    ...
                    <a
                        ...
                        href="/auth/discord"
                        class="inline-flex items-center gap-2 px-4 py-2 bg-[#5865F2] hover:bg-[#4752C4] text-white rounded-lg font-semibold transition-colors duration-200 stevie-sans-bold uppercase text-sm whitespace-nowrap"
                    >
